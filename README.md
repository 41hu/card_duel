...
双人对战回合制卡牌游戏。78 张共享牌堆、10 名角色、11 格棋盘，在横线棋盘上通过卡牌攻防博弈。
...
- **10 名角色**：剑士 / 弓手 / 法师 / 圣骑士 / 刺客 / 牧师 / 狂战士 / 邪术师 / 快枪手 / 猎人，各有独特主动技能与被动
...
**平衡性改动自检清单**（改完逐项确认）：
1. 数值一致性：`CARD_COUNTS` 各卡数量总和仍为 78？角色仍为 10 名？武器/防具池数量与文档一致？
