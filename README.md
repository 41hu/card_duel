...
双人/多人回合制战术卡牌对战游戏。15 名角色、经典共享牌堆 + 自定义卡组构筑，在横线/六边形棋盘上通过出牌、移动、响应博弈。
...
- **15 名角色**：斗士 / 神射手 / 法师 / 圣骑士 / 刺客 / 牧师 / 狂战士 / 邪术师 / 快枪手 / 猎人 / 寻踪者 / 铸甲师 / 魔剑士 / 巫女 / 饲甲人，各有独特主动技能与被动（如饲甲人的「活铠」魔甲、铸甲师的护甲注魔/修复/韧性）
- **两种卡组模式**：经典 78 张共享牌堆；自定义卡组（每角色 3 套预设，40 张四池配额：攻击17/战术14/回复6/装备5）
- **响应博弈**：攻击可被格挡（近战）/ 牵制（远程）/ 闪避（魔法）——猜对方手牌是核心乐趣
- **人机对战**：四档难度 AI（简单 / 普通 / 困难 / 地狱），单机随时可玩
- **4 人混战**：本地或联机六边形棋盘混战，最后存活者胜
- **武器幻化池**：自定义每类型武器池，场上武器全局独占；15 把武器各带独特命中特效
- **结算统计**：每局展示伤害 / 治疗 / 出牌 / 复活统计与结束时面板成长，获胜者按表现获得称号（完美击杀、毁灭之王、不死凤凰……）
- **服务端权威联机**：WebSocket 对战，手机 / 电脑跨端，自定义卡组配置即锁定
...
**平衡性改动自检清单**（改完逐项确认）：
1. 数值一致性：`CARD_COUNTS` 各卡数量总和仍为 78？角色仍为 15 名？武器/防具池数量与文档一致？
